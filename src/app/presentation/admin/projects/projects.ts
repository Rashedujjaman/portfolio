...
import { DeleteProjectUseCase } from '../../../domain/use-cases/project.use-case';
import { UpdateProjectUseCase } from '../../../domain/use-cases/project.use-case';
...
export class AdminProjects implements OnInit {
  ...
  toggleFeatured(project: Project) {
    ...
    this.updateProjectUseCase.execute(project.id, projectData).subscribe({
      next: () => {
        this.showSuccess(
          `Project ${
  ...
  deleteProject(project: Project) {
    if (
      ...
      this.deleteProjectUseCase.execute(project.id).subscribe({
        next: () => {
